    ...
    <div class="listadocumento1">
        ...
        <div id="tabela">
            <form method="post" action="editar-documento.php" enctype="multipart/form-data">
                ...
                <div id="imprimir-pdf">
                    <button type="button" onclick="ImprimeDiv()">Imprimir PDF</button>
                    <- preciso arrumar aff </div>

                        <script>
                            function ImprimeDiv() {
                                var divContents = document.getElementById("imprimir-pdf").innerHTML;
                                var a = window.open('', '');
                                a.document.write('<html>');
                                a.document.write('<body><button onclick="window.print()">Imprimir</button>');
