...
<body>
    ...
    if (isset($_POST['Edit'])) {
        ...
        echo "<div id='editar-planta'>";
        echo "<h2>Quer mesmo excluir esta planta:</br></br></h2>";
        echo "<p><b> $nome_planta?</b></p>";
        echo "<form action='editar-planta.php' method='post'>";
        echo "</br></br>";
        echo "<button class='btn-editar-sim' type='submit' name='Deleted' value='$deleteid_planta'><b>Sim</b></button>";
        echo "</br></br>";
