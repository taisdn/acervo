    ...
    <div class="documento1">
        <div id="doc1">
            <form method="post" action="cadastro-documento.php" enctype="multipart/form-data">
                ...
                Nome do Documento: <input class="inpt-documento" style="width:47.5%;" type="text" name="nome_documento" placeholder="Insira o nome do documento"/></br></br>
                Autor(a) do Documento: <input class="inpt-documento" style="width:44%;" type="text" name="autor_documento" placeholder="Insira o nome do(a) autor(a)"/></br></br>
                Descrição do Documento: </br></br>
                <textarea id="area" cols='53' rows='10' name="descricao_documento" placeholder="Insira uma descrição"></textarea></br></br>
                Data da Postagem: <input class="inpt-data" style="width:51%;" type="date" name="data_e_ano_documento"/></br></br>
                Imagem do Documento: <input class="inpt-arquivo" type="file" name="imagem_documento" required/></br></br>
                Importar arquivo: <input class="inpt-arquivo" type="file"/></br></br> 
                <!--INPUT CRIADA PARA IMPORTAR ARQUIVO CSV DE ARQUIVO.PHP-->
                </br></br>
                    ...
                    <a href="painel.php">
                        << Voltar para o painel de categorias</a><br><br>
                            ...
                            <a href="lista-documento.php">
                                Ir para Lista de Documentos >></a></br></br>                                
                </div>
